...
import com.shiyu.ai.common.core.enums.CommonStatusEnum;
...
public interface SysMenuMapper extends BaseMapperPlus<SysMenu, SysMenuVo> {
    ...
    default List<SysMenu> selectMenuTreeAll() {
        ...
        LambdaQueryWrapper<SysMenu> lqw = new LambdaQueryWrapper<SysMenu>()
            .in(SysMenu::getMenuType, MenuTypeEnum.DIRECTORY.name(), MenuTypeEnum.MENU.name())
            .eq(SysMenu::getStatus, CommonStatusEnum.OK.getCode())
