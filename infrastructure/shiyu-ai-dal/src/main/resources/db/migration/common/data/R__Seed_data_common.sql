...
-- 时区
INSERT IGNORE INTO `common_dict` (`id`, `dict_type`, `dict_label`, `dict_value`, `tenant_id`, `dict_sort`, `is_default`, `status`, `remark`, `create_by`, `update_by`)
...
-- 意图编码
INSERT IGNORE INTO `common_dict` (`id`, `dict_type`, `dict_label`, `dict_value`, `tenant_id`, `dict_sort`, `status`, `remark`, `create_by`, `update_by`)
