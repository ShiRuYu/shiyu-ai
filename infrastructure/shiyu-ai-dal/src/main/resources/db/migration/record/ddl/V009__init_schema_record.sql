...
COMMENT ON TABLE record_profile IS '人物表';


CREATE TABLE IF NOT EXISTS record_profile_member (
...
CREATE INDEX IF NOT EXISTS idx_profile_user ON record_profile_member (profile_id, user_id);


COMMENT ON TABLE record_profile_member IS '人物成员关系表';


CREATE TABLE IF NOT EXISTS record_timeline_event (
...
CREATE INDEX IF NOT EXISTS idx_profile_time ON record_timeline_event (profile_id, event_time);


COMMENT ON TABLE record_timeline_event IS '时间轴事件表';
...
CREATE INDEX IF NOT EXISTS idx_event ON record_entry (event_id);


COMMENT ON TABLE record_entry IS '记录内容表';
...
CREATE INDEX IF NOT EXISTS idx_record ON record_media (record_id);


COMMENT ON TABLE record_media IS '附件表';
...
CREATE INDEX IF NOT EXISTS idx_name_creator ON record_tag (name, create_by);


COMMENT ON TABLE record_tag IS '标签表';


CREATE TABLE IF NOT EXISTS record_record_tag (
    record_id BIGINT NOT NULL COMMENT '记录ID',
...
COMMENT ON TABLE record_record_tag IS '记录标签关联表';
