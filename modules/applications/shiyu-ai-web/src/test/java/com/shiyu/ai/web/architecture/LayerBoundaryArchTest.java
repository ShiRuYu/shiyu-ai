...
class LayerBoundaryArchTest {
    ...
    @ArchTest
    static final ArchRule webMustNotDependOnDal =
            noClasses()
                    .that()
                    .resideInAnyPackage("com.shiyu.ai.web..")
                    .should()
                    .dependOnClassesThat()
                    .resideInAnyPackage("com.shiyu.ai.common.mybatis..")
                    .because(
                            "Web is an HTTP adapter and must not access persistence"
                                    + " implementations");

    @ArchTest
    static final ArchRule businessMustNotDependOnPersistenceTypes =
            noClasses()
                    .that()
                    .resideInAnyPackage(
                            "com.shiyu.ai.agent..",
                    ...
                    .because(
                            "DO and Mapper types belong exclusively to their domain implementation"
                                    + " or technical support");

    @ArchTest
    static final ArchRule repositoryPortsMustNotExposePersistenceTypes =
            noClasses()
                    .that()
                    .resideInAnyPackage("com.shiyu.ai..port.repository..")
                    .should()
                    .dependOnClassesThat()
    ...
    @ArchTest
    static final ArchRule domainApplicationMustNotReadUserContextHolder =
            noClasses()
                    .that()
                    .resideInAnyPackage(
                            "com.shiyu.ai.agent..",
