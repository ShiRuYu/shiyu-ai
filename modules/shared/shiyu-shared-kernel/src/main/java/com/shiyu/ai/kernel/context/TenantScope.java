...
/**
 * Explicit persistence tenant scope used by technical adapters such as the MyBatis tenant factory.
 * HTTP authentication code is responsible for binding it for the request lifetime; domain and
 * application code must pass {@link TenantId} explicitly instead of reading this scope.
 */
