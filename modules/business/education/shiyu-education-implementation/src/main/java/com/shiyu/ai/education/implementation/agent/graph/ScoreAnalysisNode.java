 ...
 * 评分分析节点
 *
 * <p>LangGraph4j 节点，对学生练习结果进行评分， 更新 Bloom 能力值，输出"是否需要重学"的判断。
 *
 * <p>输入字段：practiceQuestions, overallScore, studentId, knowledgeId, answerResults（可选）
...
public class ScoreAnalysisNode extends BaseNode {
    ...
    /**
     * {@code ScoreAnalysisNode} 创建并初始化当前类型实例。
     *
