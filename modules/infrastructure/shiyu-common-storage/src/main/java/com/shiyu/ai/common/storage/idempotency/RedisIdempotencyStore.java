...
public final class RedisIdempotencyStore implements IdempotencyStore {
    ...
    public RedisIdempotencyStore(StringRedisTemplate redis, RedisInfrastructureProperties properties) {
        this.redis = redis;
    ...
    public boolean putIfAbsent(String key, Duration ttl) {
        ...
        return Boolean.TRUE.equals(redis.opsForValue().setIfAbsent(properties.key("idempotency", key), "1", ttl));
    }
