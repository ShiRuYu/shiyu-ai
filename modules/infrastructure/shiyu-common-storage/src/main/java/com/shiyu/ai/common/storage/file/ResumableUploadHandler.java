...
/**
 * Domain callback used by the generic storage upload pipeline. The storage module owns bytes and
 * upload sessions; a domain module owns authorization and metadata registration.
 */
