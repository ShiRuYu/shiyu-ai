...
class FileControllerSecurityTest {
    ...
    void protectsFileReadOperationsWithDedicatedPermission() throws NoSuchMethodException {
        SaCheckPermission configPermission =
                FileController.class.getMethod("config").getAnnotation(SaCheckPermission.class);
        SaCheckPermission listPermission =
                FileController.class.getMethod("list").getAnnotation(SaCheckPermission.class);
