...
public class MybatisExceptionHandler {
    ...
    public Result<Void> handleDuplicateKeyException(DuplicateKeyException e, HttpServletRequest request) {
        log.error("数据库唯一约束冲突: requestPathLength={}, errorType={}, errorMessageLength={}",
    ...
    public Result<Void> handleCannotFindDataSourceException(MyBatisSystemException e, HttpServletRequest request) {
        ...
        if (message != null && message.contains("CannotFindDataSourceException")) {
            log.error("未找到数据源: requestPathLength={}, errorType={}, errorMessageLength={}",
                    valueLength(request.getRequestURI()), e.getClass().getSimpleName(), valueLength(message));
            return Result.fail("未找到数据源，请联系管理员确认");
        }
        log.error("Mybatis系统异常: requestPathLength={}, errorType={}, errorMessageLength={}",
                valueLength(request.getRequestURI()), e.getClass().getSimpleName(), valueLength(message));
