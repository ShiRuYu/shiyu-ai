...
/**
 * Common tool execution boundary used by Agent and future MCP adapters. It keeps
 * capability/approval/event ordering in one place; the actual executor remains supplied by the
 * owning tool platform.
 */
public final class ToolExecutionPipeline {
    ...
    /**
     * Resolve the durable run at the execution boundary without putting a mutable AiRun object into
