    ...
    public CompiledGraph<AgentState> build() throws GraphStateException {
        ...
        for (Map.Entry<String, BaseNode> entry : nodes.entrySet()) {
            ...
            try {
                ...
                log.error(
                        "添加节点失败：nodeIdPresent={}, errorType={}, errorMessageLength={}",
                        nodeId != null,
        ...
        for (Map.Entry<String, List<String>> entry : edges.entrySet()) {
            ...
            for (String targetId : targetIds) {
                try {
                    ...
                    log.error(
                            "添加边失败：sourcePresent={}, targetPresent={}, errorType={},"
                                    + " errorMessageLength={}",
                            sourceId != null,
                            targetId != null,
                            e.getClass().getSimpleName(),
                ...
                log.debug(
                        "添加边：sourcePresent={}, targetPresent={}",
                        sourceId != null,
                        targetId != null);
            }
        }
        ...
        for (Map.Entry<String, ConditionEdge> entry : conditionalEdges.entrySet()) {
            ...
            if (!mappings.isEmpty()) {
                try {
                    ...
                    log.error(
                            "添加条件边失败：sourcePresent={}, errorType={}, errorMessageLength={}",
                            sourceId != null,
                            e.getClass().getSimpleName(),
                            e.getMessage() == null ? 0 : e.getMessage().length());
                    throw e;
        ...
        if (startNode != null && !startNode.isEmpty()) {
            try {
                ...
                log.error(
                        "添加起始边失败：startNodePresent={}, errorType={}, errorMessageLength={}",
                        startNode != null,
                        e.getClass().getSimpleName(),
                        e.getMessage() == null ? 0 : e.getMessage().length());
                throw e;
        ...
        if (endNode != null && !endNode.isEmpty()) {
            try {
                ...
                log.error(
                        "添加结束边失败：endNodePresent={}, errorType={}, errorMessageLength={}",
                        endNode != null,
                        e.getClass().getSimpleName(),
                        e.getMessage() == null ? 0 : e.getMessage().length());
                throw e;
