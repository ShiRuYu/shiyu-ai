...
import com.shiyu.ai.agent.implementation.runtime.service.DefaultContextPolicy;
...
class DefaultContextPolicyTest {
    ...
    private final ContextQuery query =
            new ContextQuery(
                    ...
                    new com.shiyu.ai.kernel.context.UserId(2L),
                    "agent",
                    "question",
                    5,
                    null);
    ...
    void acceptsOnlyItemsWithAnExplicitNonBlankAccessScope() {
        ...
        ContextItem blank =
                new ContextItem(
                        "MEMORY", "m-2", "content", 0.9, null, List.of(), " ", Instant.now());
