...
class ConditionEdgeCoverageTest {
    ...
    @Test
    void reportsNullEdgeDefinitionsAsGraphValidationErrors() {
        Graph nullTargets = new Graph();
        nullTargets.addNode("start", mock(BaseNode.class)).setStartNode("start");
        ...
        nullConditional.addNode("start", mock(BaseNode.class)).setStartNode("start");
