...
class AgentValueValidationCoverageTest {
    ...
    void validatesAppAndVersionIdentityAndAppliesDefaults() {
        ...
        AiApp defaults =
                new AiApp("a", new TenantId(1), new UserId(2), "name", null, " ", null, null, null);
    ...
    void validatesApprovalAndEvaluationValueObjects() {
        ...
        ToolApproval normalized =
                new ToolApproval("a", "run", 1, 2, "tool", null, null, null, null, null);
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalDataset(null, 1, 2, "name", null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalDataset(" ", 1, 2, "name", null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalDataset("d", 0, 2, "name", null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalDataset("d", 1, 0, "name", null, now));
        assertThrows(
                IllegalArgumentException.class, () -> new EvalDataset("d", 1, 2, null, null, now));
        assertThrows(
                IllegalArgumentException.class, () -> new EvalDataset("d", 1, 2, " ", null, now));
        assertNotNull(new EvalDataset("d", 1, 2, "name", null, null).createdAt());

        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalCase(null, "d", 1, "input", null, null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalCase(" ", "d", 1, "input", null, null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalCase("c", null, 1, "input", null, null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalCase("c", " ", 1, "input", null, null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalCase("c", "d", 0, "input", null, null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalCase("c", "d", 1, null, null, null, now));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalCase("c", "d", 1, " ", null, null, now));
        assertEquals("", new EvalCase("c", "d", 1, "input", null, null, now).expected());

        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalRun(null, "d", 1, 2, null, null, null, 0, null, now, null));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalRun(" ", "d", 1, 2, null, null, null, 0, null, now, null));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalRun("r", null, 1, 2, null, null, null, 0, null, now, null));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalRun("r", " ", 1, 2, null, null, null, 0, null, now, null));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalRun("r", "d", 0, 2, null, null, null, 0, null, now, null));
        assertThrows(
                IllegalArgumentException.class,
                () -> new EvalRun("r", "d", 1, 0, null, null, null, 0, null, now, null));
    ...
    private static AiAppVersion version(String id, String appId, long tenant, String number) {
        return new AiAppVersion(
                id, appId, new TenantId(tenant), number, "{}", "DRAFT", Instant.now(), null);
    }

    private static ToolApproval approval(
            String id, String run, long tenant, long owner, String tool) {
