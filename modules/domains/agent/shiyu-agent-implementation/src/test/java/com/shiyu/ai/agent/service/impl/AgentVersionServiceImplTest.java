...
class AgentVersionServiceImplTest {
    ...
    void editsGraphNodesAndEdgesAndReturnsValidation() {
        ...
        graph.setNodes(Map.of("start", new GraphConfigRequest.NodeConfigDTO(), "end", new GraphConfigRequest.NodeConfigDTO()));
    ...
    void validatesGraphNodesAndEdgesInsteadOfAcceptingEveryConfiguration() {
        ...
        GraphConfigRequest.ConditionalEdgeDTO conditionalEdge = new GraphConfigRequest.ConditionalEdgeDTO();
