...
/**
 * Bounded speaker selection for a group conversation. It deliberately only plans one turn; the
 * caller must persist the resulting GenerationRun before asking for another turn.
 */
