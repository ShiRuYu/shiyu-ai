...
public final class PromptAssembler {
    ...
    /**
     * Selects only the active leaf's ancestry. A conversation stores all branch candidates in one
     * table, so sequence order alone is not a valid prompt boundary once an edit or retry has
     * created siblings.
     *
     * <p>The repository returns messages in ascending order for this helper.
     */
