...
/**
 * 验证 Group Turn Planner 相关功能、边界条件、异常路径和协作行为。
 */
class GroupTurnPlannerTest {
    private static final List<GroupChat.Participant> PARTICIPANTS =
            List.of(
    ...
    void roundRobinAndMaxTurnsAreBounded() {
        GroupChat group =
                new GroupChat("g", "test", PARTICIPANTS, SpeakerPolicy.ROUND_ROBIN, 2, 100);
    ...
    void manualRequiresParticipantAndModelRoutedBalancesTurns() {
        ...
        assertThrows(
                ...
                () -> GroupTurnPlanner.next(manual, List.of(), "unknown", 0));
        GroupChat routed =
                new GroupChat("g", "test", PARTICIPANTS, SpeakerPolicy.MODEL_ROUTED, 4, 100);
        ...
        assertThrows(
                ...
                () ->
                        new GroupChat(
                                "g",
                                "bad",
                                List.of(new GroupChat.Participant("", "", "")),
                                null,
                                2,
                                100));
        assertThrows(
                ...
                () ->
                        new GroupChat(
                                "g",
                                "bad",
                                List.of(PARTICIPANTS.get(0), PARTICIPANTS.get(0)),
                                null,
                                2,
                                100));
        assertThrows(
                ...
                () ->
                        new GroupChat(
                                "g",
                                "bad",
                                java.util.Collections.nCopies(33, PARTICIPANTS.get(0)),
                                null,
                                2,
                                100));
        assertThrows(
                ...
                () ->
                        new GroupChat(
                                "g",
                                "bad",
                                java.util.Arrays.asList((GroupChat.Participant) null),
                                null,
                                2,
                                100));
        assertThrows(
