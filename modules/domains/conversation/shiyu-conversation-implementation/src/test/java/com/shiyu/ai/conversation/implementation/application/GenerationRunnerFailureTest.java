    ...
    void synchronousProviderFailureLeavesAReplayedFailedRun() {
        ...
        GenerationRunner runner =
                new GenerationRunner(
                        ...
                        generations,
                        conversations,
                        new com.shiyu.ai.conversation.contract.api.GenerationUsageSink() {},
                        admission,
                        (AiRuntimePort) null,
        ...
        verify(admission)
                .release(
                        ...
                        argThat(run -> run.status() == GenerationStatus.FAILED));
        ...
        verify(generations, never())
                .appendEvent(
                        argThat(event -> event.type() == GenerationEventType.COMPLETED),
                        eq(new TenantId(1L)));
