...
class PromptAssemblyServiceTest {
    ...
    void assemblesOptionalSourcesInStableOrderAndSkipsDisabledLorebookEntries() {
        ...
        CharacterCardV2 character =
                new CharacterCardV2(null, "Ava", "desc", "scene", "hello", null, "system", null, 0);
        ...
        LorebookEntry disabled =
                new LorebookEntry("disabled", List.of(), "hidden", 99, "before", 0, false);
    ...
    void queryAwareAssemblyFiltersKeysCapsEntriesAndHandlesEmptyInputs() {
        LorebookEntry matched =
                new LorebookEntry("matched", List.of("Magic"), "1234567890", 10, "before", 1, true);
        LorebookEntry noKey = new LorebookEntry("no-key", List.of(), "free", 5, "before", 0, true);
        LorebookEntry unmatched =
                new LorebookEntry("unmatched", List.of("science"), "skip", 20, "before", 0, true);
        LorebookEntry tooLarge =
                new LorebookEntry("large", List.of("magic"), "skip-budget", 1, "before", 10, true);
        List<ConversationMessage> result =
                service.assemble(
                        null,
                        null,
                        null,
                        null,
                        List.of(unmatched, matched, noKey, tooLarge),
                        null,
                        null,
                        null,
                        "magic",
        ...
        List<ConversationMessage> blankQuery =
                service.assemble(
                        List.of(),
                        List.of(),
                        null,
