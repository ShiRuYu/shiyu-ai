...
class PluginControllerTest {
    ...
    void lifecycleFailuresAreReturnedAsStableFailuresAndMarketDelegates() {
        ...
        var startFailure = controller.startPlugin("bad");
        var stopFailure = controller.stopPlugin("bad");
        var uninstallFailure = controller.uninstallPlugin("bad");
        var scanFailure = controller.rescan();
        assertFalse(startFailure.isSuccess());
        assertFalse(stopFailure.isSuccess());
        assertFalse(uninstallFailure.isSuccess());
        assertFalse(scanFailure.isSuccess());
