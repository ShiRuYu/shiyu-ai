...
class ToolingLifecycleAndWebTest {
    ...
    void managesPluginLifecycleAndRecordsFailures() {
        ...
        com.shiyu.ai.tooling.implementation.plugin.spi.PluginContext context = new com.shiyu.ai.tooling.implementation.plugin.spi.PluginContext("meta", "plugins/meta", Map.of("x", 1));
    ...
    void loadsServiceProviderJarsAndMarksFailures() throws Exception {
        ...
        try (JarOutputStream output = new JarOutputStream(Files.newOutputStream(jar))) {
            output.putNextEntry(new JarEntry("META-INF/services/com.shiyu.ai.tooling.implementation.plugin.spi.Plugin"));
            output.write((JarPlugin.class.getName() + "\n").getBytes(StandardCharsets.UTF_8));
            output.closeEntry();
        }
        com.shiyu.ai.tooling.implementation.plugin.lifecycle.PluginLoader loader = new com.shiyu.ai.tooling.implementation.plugin.lifecycle.PluginLoader();
    ...
    void mapsMcpQueriesAndPluginOperationsToResultResponses() {
        ...
        PluginController plugins = new PluginController(registry, mock(com.shiyu.ai.tooling.implementation.plugin.market.PluginMarketService.class));
