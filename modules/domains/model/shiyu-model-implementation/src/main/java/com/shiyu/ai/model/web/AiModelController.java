...
public class AiModelController {
    ...
    public Result<PageData<AiModelVO>> getPage(
        ...
        var result = aiModelService.pageResponse(ActorContextHttpAdapter.currentActor(), platformId, pageNo, pageSize);
    ...
    public Result<List<AiModelVO>> getByPlatformId(@RequestParam Long platformId) {
        var list = aiModelService.byPlatformResponse(ActorContextHttpAdapter.currentActor(), platformId);
    ...
    public Result<List<AiModelResponse>> getByPlatformCode(@RequestParam String platformCode) {
        List<AiModelResponse> list = aiModelService.byPlatformCodeResponse(ActorContextHttpAdapter.currentActor(), platformCode);
    ...
    public Result<List<IdNameOptionVO>> getOptions(
            @RequestParam(required = false) Long platformId) {
        List<IdNameOptionVO> list = aiModelService.getOptions(ActorContextHttpAdapter.currentActor(), platformId);
        return Result.success(list);
    }
    ...
    public Result<AiModelVO> getById(@RequestParam Long id) {
        AiModelResponse response = aiModelService.detailResponse(ActorContextHttpAdapter.currentActor(), id);
        if (response != null) {
    ...
    public Result<AiModelVO> getDefaultByPlatformId(@RequestParam Long platformId) {
        AiModelResponse response = aiModelService.defaultResponse(ActorContextHttpAdapter.currentActor(), platformId);
        if (response != null) {
            return Result.success(com.shiyu.ai.common.core.utils.MapstructUtils.convert(response, AiModelVO.class));
        }
    ...
    public Result<AiModelVO> create(@Valid @RequestBody AiModelRequest request) {
        try {
            AiModelResponse created = aiModelService.createResponse(ActorContextHttpAdapter.currentActor(), request);
    ...
    public Result<AiModelVO> update(@RequestParam Long id, @Valid @RequestBody AiModelRequest request) {
        try {
            AiModelResponse updated = aiModelService.updateResponse(ActorContextHttpAdapter.currentActor(), id, request);
            modelManager.markDirty();
    ...
    public Result<AiModelVO> setDefault(@RequestParam Long id) {
        try {
            AiModelResponse response = aiModelService.setDefaultResponse(ActorContextHttpAdapter.currentActor(), id);
            modelManager.markDirty();
            return Result.success(com.shiyu.ai.common.core.utils.MapstructUtils.convert(response, AiModelVO.class));
        } catch (Exception e) {
