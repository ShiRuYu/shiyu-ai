...
/**
 * 验证 模型 Provider Capabilities 相关功能、边界条件、异常路径和协作行为。
 */
class ModelProviderCapabilitiesTest {
    @Test
    void appliesDefaultsAndFeatureFlags() {
        ModelProviderCapabilities defaults =
                new ModelProviderCapabilities("OPENAI", "gpt", null, 0);
        ...
        ModelProviderCapabilities features =
                new ModelProviderCapabilities(
                        "OPENAI",
                        "gpt",
                        Set.of("tool_calls", "parallel_tool_calls", "structured"),
                        2048,
                        false,
                        true,
                        true,
    ...
    void rejectsMissingProviderOrModelAndNormalizesInvalidLimits() {
        ...
        ModelProviderCapabilities normalized =
                new ModelProviderCapabilities(
                        "OPENAI",
                        "gpt",
                        Set.of("chat"),
    ...
    void handlesBlankFeaturesAndCopiesMutableInputs() {
        ...
        ModelProviderCapabilities capabilities =
                new ModelProviderCapabilities(
                        "OPENAI", "gpt", features, 1, true, false, false, false, false, reasoning,
                        1, true, false, true);
        features.add("tools");
        reasoning.add("high");
