...
class ModelRepositoryCoverageTest {
    ...
    void coversTenantScopedModelAndPlatformRepositoryQueriesAndMutations() throws Exception {
        ...
        com.shiyu.ai.model.implementation.persistence.mapper.AiModelMapper modelMapper =
                mock(
                        com.shiyu.ai.model.implementation.persistence.mapper.AiModelMapper.class,
                        mapperAnswer(false));
        ...
        com.shiyu.ai.model.implementation.persistence.mapper.AiPlatformMapper platformMapper =
                mock(
                        com.shiyu.ai.model.implementation.persistence.mapper.AiPlatformMapper.class,
                        mapperAnswer(true));
        ...
        try (MockedStatic<MapstructUtils> conversions = mockStatic(MapstructUtils.class)) {
            ...
            models.deleteById(TENANT, 1L);
            models.deleteByIds(TENANT, List.of(1L, 2L));
            assertEquals(1, models.selectOptions(TENANT, null).size());
            models.clearDefaultExcept(TENANT, 2L, null);
            models.clearDefaultExcept(TENANT, 2L, 1L);
            ...
            platforms.deleteById(TENANT, 1L);
            assertEquals(1, platforms.selectOptions(TENANT).size());
            platforms.clearDefaultExcept(TENANT, null);
            platforms.clearDefaultExcept(TENANT, 1L);
        }
    }
        ...
        return invocation -> {
            ...
            if (name.startsWith("selectListByQuery")) {
                if (platformMapper) {
                    ...
                    value.setId(1L);
                    value.setName("Platform");
                    value.setCode("code");
                    return List.of(value);
                }
                AiModelDO value = new AiModelDO();
                value.setId(1L);
                value.setDisplayName("Model");
                value.setModelName("model");
                return List.of(value);
            }
