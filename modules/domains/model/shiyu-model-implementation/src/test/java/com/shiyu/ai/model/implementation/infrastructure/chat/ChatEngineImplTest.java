...
class ChatEngineImplTest {
        ...
        when(model.chat(any(dev.langchain4j.model.chat.request.ChatRequest.class)))
                .thenReturn(
                        dev.langchain4j.model.chat.response.ChatResponse.builder()
                                .modelName("provider-gpt")
                                .aiMessage(aiMessage)
                                .tokenUsage(new dev.langchain4j.model.output.TokenUsage(4, 6, 10))
                                .build());

        ChatResponse response =
                new ChatEngineImpl(manager, publisher).chat(request("OPENAI", "gpt"));
    ...
    void streamEmitsProviderMetadataAndFailedEventWhenCallbackErrors() {
        ...
        doAnswer(
                ...
                .when(model)
                .chat(
                        any(dev.langchain4j.model.chat.request.ChatRequest.class),
                        any(
                                dev.langchain4j.model.chat.response.StreamingChatResponseHandler
                                        .class));

        List<ChatResponse> events =
                new ChatEngineImpl(manager, mock(ApplicationEventPublisher.class))
                        .stream(request("OPENAI", "gpt")).collectList().block();
        assertNotNull(events);
        assertEquals(
                "USAGE",
                events.stream()
                        .filter(e -> "USAGE".equals(e.getEventType()))
                        .findFirst()
                        .orElseThrow()
                        .getEventType());
        ChatResponse usage =
        ...
        assertTrue(
                events.stream()
                        .anyMatch(
                                e ->
                                        "DELTA".equals(e.getEventType())
                                                && "done".equals(e.getContent())));
        ...
        doAnswer(
                ...
                .chat(
                        ...
                        any(
                                dev.langchain4j.model.chat.response.StreamingChatResponseHandler
                                        .class));
        List<ChatResponse> failedEvents =
                new ChatEngineImpl(manager, mock(ApplicationEventPublisher.class))
                        .stream(request("OPENAI", "failed"))
    ...
    void rejectsNullRequestWhenBuildingUsageAttribution() throws Exception {
        ChatEngineImpl engine =
                new ChatEngineImpl(mock(ModelManager.class), mock(ApplicationEventPublisher.class));
    ...
    void invalidAndUnavailableRequestsReturnStableFailure() {
        ...
        ChatResponse invalid =
                engine.chat(ChatRequest.builder().platform("OPENAI").messages(List.of()).build());
    ...
    void streamEmitsLifecycleAndUsageEvents() {
        ...
        assertTrue(
                events.stream()
                        .anyMatch(
                                event ->
                                        "DELTA".equals(event.getEventType())
                                                && "hel".equals(event.getContent())));
    ...
    void nativeMessageValidationRejectsUnsupportedFileContent() {
        ...
        ChatMessage file =
                new ChatMessage(
                        "user",
                        List.of(new ChatMessage.ContentPart("file", null, "file://x", null)));
        ChatRequest request =
                ChatRequest.builder()
                        .platform("OPENAI")
                        .model("gpt")
                        .messages(List.of(file))
                        .build();

        ChatResponse response =
                new ChatEngineImpl(manager, mock(ApplicationEventPublisher.class)).chat(request);
        assertFalse(response.isSuccess());
    ...
    void chatEstimatesUsageAndMapsToolCallsWhenProviderOmitsUsage() {
        ...
        ChatModel model = mock(ChatModel.class);
        when(manager.getChatModel("OPENAI", "gpt")).thenReturn(model);
        dev.langchain4j.agent.tool.ToolExecutionRequest call =
        ...
        when(model.chat(any(dev.langchain4j.model.chat.request.ChatRequest.class)))
                .thenReturn(
                        dev.langchain4j.model.chat.response.ChatResponse.builder()
                                .aiMessage(AiMessage.from("answer", List.of(call)))
                                .build());
                ...
                new ChatMessage(
                        ...
                        List.of(
                                new ChatMessage.ContentPart(
                                        "tool_call", "", null, null, "id", "search", "{}", 0)));
        ChatMessage tool =
                new ChatMessage(
                        "tool",
                        List.of(
        ...
        List<ChatMessage> messages =
                List.of(
                        ...
                        new ChatMessage(
                                ...
                                List.of(
                                        new ChatMessage.ContentPart(
                                                "image", null, "https://img", "image/png"),
                                        new ChatMessage.ContentPart(
                                                "audio", null, "https://audio", "audio/wav"))));
        ChatRequest request =
                ChatRequest.builder()
                        .platform("OPENAI")
                        .model("gpt")
        ...
        List<ChatMessage> messages =
                List.of(
                        new ChatMessage(
                                ...
                                List.of(
                                        new ChatMessage.ContentPart(
                                                "text", "assistant", null, null))),
                        new ChatMessage("tool", List.of()),
                        new ChatMessage(
                                "user",
                                List.of(
                                        new ChatMessage.ContentPart(
                                                "image", null, null, "image/png"),
                                        new ChatMessage.ContentPart(
                                                "audio", null, null, "audio/wav"),
                                        new ChatMessage.ContentPart(
                                                "reasoning", "internal", null, null),
                                        new ChatMessage.ContentPart(
                                                "text", "visible", null, null))));
        ChatRequest request =
                ChatRequest.builder()
                        .platform("OPENAI")
                        .model("gpt")
    ...
    void routesChatAndStreamThroughTenantScopedPolicy() {
        ...
        router.savePolicy(
                new ModelRoutePolicy(
                        "route-1", 7L, "Primary", List.of("OPENAI:gpt-4o"), 1000, true, 1000));
        ChatModel chat = mock(ChatModel.class);
        when(manager.getChatModel("OPENAI", "gpt-4o")).thenReturn(chat);
        when(chat.chat(any(dev.langchain4j.model.chat.request.ChatRequest.class)))
                .thenReturn(
                        dev.langchain4j.model.chat.response.ChatResponse.builder()
                                .aiMessage(AiMessage.from("routed"))
                                .build());
        ChatRequest request =
                ChatRequest.builder()
        ...
        doAnswer(
                        invocation -> {
                            ...
                            handler.onCompleteResponse(
                                    dev.langchain4j.model.chat.response.ChatResponse.builder()
                                            .aiMessage(AiMessage.from("route"))
                                            .build());
                            return null;
                        })
                .when(streaming)
    ...
    void rejectsRouteWithoutHealthyCandidates() {
        ...
        router.savePolicy(
                new ModelRoutePolicy(
                        "route-2", 7L, "Missing", List.of("configured"), 1000, false, 1000));
        ChatRequest request =
                ChatRequest.builder()
                        ...
                        .build();
        ChatEngineImpl engine =
                new ChatEngineImpl(manager, mock(ApplicationEventPublisher.class), router);
    ...
    void streamCoversThinkingToolCallsEmptyDeltasAndFinalFlush() {
        ...
        doAnswer(
                        invocation -> {
                            ...
                            handler.onCompleteResponse(
                                    dev.langchain4j.model.chat.response.ChatResponse.builder()
                                            .aiMessage(AiMessage.from("final"))
                                            .modelName(null)
                                            .tokenUsage(null)
                                            .build());
                            return null;
    ...
    void validatesMalformedMessagesAndHandlesDeepSeekAndUnavailableStreaming() {
        ...
        assertEquals(
                ...
                engine.chat(ChatRequest.builder().messages(List.of()).build()).getErrorMessage());
        ...
        assertEquals(
                ...
                engine.chat(
                                ChatRequest.builder()
                                        .platform("OPENAI")
                                        .messages(List.of(malformed))
                                        .build())
                        .getErrorMessage());
        ChatMessage badPart =
                new ChatMessage(
                        "user", List.of(new ChatMessage.ContentPart("unknown", "x", null, null)));
        assertEquals(
                "unsupported content part type: unknown",
                engine.chat(
                                ChatRequest.builder()
                                        .platform("OPENAI")
                                        .messages(List.of(badPart))
                                        .build())
                        .getErrorMessage());

        ModelManager deepManager = mock(ModelManager.class);
        com.shiyu.ai.model.implementation.infrastructure.adapter.impl.DeepSeekHttpProvider
                deepSeek =
                        mock(
                                com.shiyu.ai.model.implementation.infrastructure.adapter.impl
                                        .DeepSeekHttpProvider.class);
        when(deepManager.getDeepSeekProvider()).thenReturn(deepSeek);
        when(deepSeek.isAvailable()).thenReturn(true);
        when(deepSeek.stream(any()))
                .thenReturn(Flux.just(ChatResponse.builder().eventType("USAGE").build()));
        List<ChatResponse> deepEvents =
                new ChatEngineImpl(deepManager, mock(ApplicationEventPublisher.class))
        ...
        assertThrows(
                Exception.class,
                () ->
                        new ChatEngineImpl(unavailable, mock(ApplicationEventPublisher.class))
    ...
    void rejectsUnavailableDeepSeekAndHandlesNullProviderResponse() {
        ...
        assertThrows(
                Exception.class,
                () -> engine.stream(request("DEEPSEEK", "deepseek-chat")).collectList().block());
    ...
    void serializesToolDefinitionsAndRejectsMalformedToolDefinitions() {
        ...
        assertTrue(
                new ChatEngineImpl(manager, mock(ApplicationEventPublisher.class))
                        .chat(request)
                        .isSuccess());
        ChatRequest malformed =
                ChatRequest.builder()
                        .platform("OPENAI")
                        .model("gpt")
                        .messages(List.of(ChatMessage.text("user", "hello")))
                        .tools(List.of(new ChatRequest.ToolDefinition("", null, "{}")))
                        .build();
        assertFalse(
                new ChatEngineImpl(manager, mock(ApplicationEventPublisher.class))
                        .chat(malformed)
    ...
    void routesMultimodalToolRequestThroughCapabilitySelection() {
        ...
        router.savePolicy(
                new ModelRoutePolicy(
                        "route-mm", 7L, "MM", List.of("OPENAI:gpt-4o"), 1000, true, 1000));
        ChatModel model = mock(ChatModel.class);
                                        ...
                                        new ChatMessage(
                                                ...
                                                List.of(
                                                        new ChatMessage.ContentPart(
                                                                ...
                                                                "https://img",
                                                                "image/png")))))
                        .tools(List.of(new ChatRequest.ToolDefinition("search", null, null)))
                        .build();
        assertFalse(
                new ChatEngineImpl(manager, mock(ApplicationEventPublisher.class), router)
                        .chat(request)
    ...
    void routedChatUsesStructuredDeepSeekCandidate() {
        ...
        router.savePolicy(
                new ModelRoutePolicy(
                        ...
                        7L,
                        "Deep",
                        List.of("DEEPSEEK:deepseek-v4-flash"),
                        1000,
                        false,
                        1000));
        DeepSeekHttpProvider provider = mock(DeepSeekHttpProvider.class);
    ...
    void routedStreamFallsBackWhenFirstProviderFailsBeforeVisibleOutput() {
        ...
        router.savePolicy(
                new ModelRoutePolicy(
                        "route-stream-fallback",
                        7L,
                        "Fallback",
                        List.of("OPENAI:gpt-4o", "default:configured"),
                        1000,
                        true,
                        1000));
        ...
        ChatRequest request =
                ChatRequest.builder()
                        .modelRouteId("route-stream-fallback")
                        .tenantId(7)
                        .platform("OPENAI")
                        .model("ignored")
                        .messages(List.of(ChatMessage.text("user", "hello")))
        ...
        assertTrue(
                events.stream()
                        .anyMatch(
                                event ->
                                        "DELTA".equals(event.getEventType())
                                                && "fallback".equals(event.getContent())));
        verify(second)
                .chat(
                        any(dev.langchain4j.model.chat.request.ChatRequest.class),
                        any(
