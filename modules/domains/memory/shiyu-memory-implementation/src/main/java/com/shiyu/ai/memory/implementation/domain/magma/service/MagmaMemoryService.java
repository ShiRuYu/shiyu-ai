...
import com.shiyu.ai.memory.implementation.domain.magma.port.MemoryGovernancePort;
...
public class MagmaMemoryService
    ...
    /**
     * semanticIndex 属性，保存当前对象中的业务数据或协作依赖。
     */
    private final MemorySemanticIndex semanticIndex;
    /**
     * accessPolicy 属性，保存当前对象中的业务数据或协作依赖。
     */
