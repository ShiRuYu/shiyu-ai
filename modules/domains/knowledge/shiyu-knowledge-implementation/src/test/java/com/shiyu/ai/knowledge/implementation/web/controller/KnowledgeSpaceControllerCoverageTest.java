...
/**
 * 验证 知识 空间 Controller Coverage 相关功能、边界条件、异常路径和协作行为。
 */
class KnowledgeSpaceControllerCoverageTest {
    ...
    void mapsSpaceQueriesMutationsAndMembers() {
        KnowledgeSpaceService.CreateSpaceRequest create =
                new KnowledgeSpaceService.CreateSpaceRequest(
                        "main", "Main", "general", null, "PRIVATE", "MANUAL", "NONE", null,
                        "default", null, "fixed", 500, 50);
        KnowledgeSpaceService.UpdateSpaceRequest update =
                new KnowledgeSpaceService.UpdateSpaceRequest(
                        "Renamed", null, "general", "PRIVATE", "MANUAL", "NONE", null, "default",
                        null, "fixed", 500, 50, 1);
        KnowledgeSpaceService.MemberRequest member =
                new KnowledgeSpaceService.MemberRequest("USER", 8L, "EDITOR");
