...
import com.shiyu.ai.knowledge.implementation.infrastructure.retrieval.service.EmbeddedKnowledgeRetrievalService;
...
class EmbeddedKnowledgeRetrievalServiceTest {
    ...
    void validatesSecurityContextAndRetrievesDeduplicatedDocumentsAndEntries() {
        ...
        when(index.hybridSearch(
                ...
                .thenReturn(
                        List.of(
                                new KnowledgeIndexService.HybridHit(
                                        11L, 13L, longContent, "math", 0.3, 0.4, 0.8, 0.0),
                                new KnowledgeIndexService.HybridHit(
                                        11L, 13L, "duplicate", "", 0.9, 0.1, 0.2, 0.0)));
        EmbeddedKnowledgeRetrievalService service =
                new EmbeddedKnowledgeRetrievalService(spaces, index, knowledge, chunks, documents);
        ...
        assertFalse(
                service.retrieve(
                                new KnowledgeRetrievalRequest(
                                        null, List.of(), Set.of(), null, "math", null, null, null,
                                        null))
                        .success());
        assertFalse(
                service.retrieve(
                                new KnowledgeRetrievalRequest(
                                        ACTOR, null, Set.of(), null, null, null, null, null, null))
                        .success());
        assertFalse(
                service.retrieve(
                                new KnowledgeRetrievalRequest(
                                        ACTOR, List.of(), Set.of(), null, "  ", null, null, null,
                                        null))
                        .success());
        ...
        verify(index)
                .hybridSearch(
                        eq(ACTOR), eq(10L), eq("math"), eq("HYBRID"), eq(10), eq(0D), eq(false));
    }
    ...
    void handlesSelectedSpacesEmptySourcesMissingChunkAndInvalidMetadata() {
        ...
        KnowledgeSpaceService.SpaceView space =
                new KnowledgeSpaceService.SpaceView(
                        10L, "s", "d", "Space", "", "PUBLIC", "", "", null, "", "", "", 200, 20,
                        null, 1, null, null);
        KnowledgeSpaceService.SpaceView otherSpace =
                new KnowledgeSpaceService.SpaceView(
                        99L, "s99", "d", "Other", "", "PUBLIC", "", "", null, "", "", "", 200, 20,
                        null, 1, null, null);
        when(spaces.accessibleSpaces(ACTOR)).thenReturn(List.of(space));
        doNothing()
                .when(spaces)
                .requireAccess(anyLong(), any(KnowledgeSpaceService.SpaceRole.class), eq(ACTOR));
        when(index.hybridSearch(
                ...
                .thenReturn(
                        List.of(
                                new KnowledgeIndexService.HybridHit(
                                        99L, 13L, null, null, 0D, 0D, 0D, 0.4D)));
                ...
                () ->
                        service.retrieve(
                                new KnowledgeRetrievalRequest(
                                        ACTOR,
                                        List.of(99L),
                                        Set.of(KnowledgeSourceType.DOCUMENT),
        ...
        KnowledgeRetrievalResult missingChunk =
                service.retrieve(
                        new KnowledgeRetrievalRequest(
                                ACTOR,
                                List.of(99L),
        ...
        assertTrue(
                service.retrieve(
                                new KnowledgeRetrievalRequest(
                                        ACTOR, List.of(), Set.of(), null, "q", 1, 1, null, null))
                        .hits()
                        .isEmpty());

        when(spaces.accessibleSpaces(ACTOR)).thenReturn(List.of(space));
        KnowledgeRetrievalResult entries =
                service.retrieve(
                        new KnowledgeRetrievalRequest(
                                ACTOR,
                                List.of(),
                                Set.of(KnowledgeSourceType.KNOWLEDGE_ENTRY),
                                null,
                                "other",
                                1,
                                0,
    ...
    void mapsDocumentFallbacksAndRanksMixedSourcesForExplicitSpaces() {
        ...
        when(index.hybridSearch(
                ...
                .thenReturn(
                        List.of(
                                new KnowledgeIndexService.HybridHit(
                                        11L, 13L, null, null, 0.8D, 0.1D, 0D, 0.9D)));
                ...
                service.retrieve(
                        new KnowledgeRetrievalRequest(
                                ...
                                Set.of(
                                        ...
                                        KnowledgeSourceType.KNOWLEDGE_ENTRY),
    ...
    void coversRetrievalScoringMetadataAndTextHelperEdges() throws Exception {
        EmbeddedKnowledgeRetrievalService service =
                new EmbeddedKnowledgeRetrievalService(
        ...
        Method knowledgeId =
                EmbeddedKnowledgeRetrievalService.class.getDeclaredMethod(
                        "knowledgeId", KnowledgeChunkBO.class);
        ...
        Method rank =
                EmbeddedKnowledgeRetrievalService.class.getDeclaredMethod(
                        "rankScore", KnowledgeRetrievalHit.class);
        ...
        assertEquals(
                ...
                rank.invoke(
                        ...
                        new KnowledgeRetrievalHit(
                                10L, 1L, null, null, null, "title", "content", null, null, null,
                                0.1D, 0.2D, 0.3D, 0.9D)));
        assertEquals(
                0.3D,
                rank.invoke(
        ...
        Method contains =
                EmbeddedKnowledgeRetrievalService.class.getDeclaredMethod(
                        "contains", String.class, String.class);
    ...
    void filtersKnowledgeEntriesByNameOrDescriptionAndUsesFallbackDocumentTitle() {
        ...
        byDescription.setId(1L);
        byDescription.setSpaceId(10L);
        byDescription.setName("unrelated");
        byDescription.setDescription("Physics reference");
        KnowledgeBO noMatch = new KnowledgeBO();
        noMatch.setId(2L);
        noMatch.setSpaceId(10L);
        noMatch.setName("history");
        noMatch.setDescription(null);
        KnowledgeBO nullTitle = new KnowledgeBO();
        nullTitle.setId(3L);
        nullTitle.setSpaceId(10L);
        nullTitle.setName(null);
        nullTitle.setDescription("Physics notes");
        when(knowledge.findBySpace(ACTOR.tenantId(), 10L))
                .thenReturn(List.of(byDescription, noMatch, nullTitle));
        ...
        when(index.hybridSearch(
                ...
                .thenReturn(
                        List.of(
                                new KnowledgeIndexService.HybridHit(
                                        7L, 21L, "chunk", "", 0.5D, 0.1D, 0.2D, 0D)));
        KnowledgeChunkBO chunk = new KnowledgeChunkBO();
        chunk.setId(7L);
        ...
        KnowledgeRetrievalResult documentResult =
                service.retrieve(
                        new KnowledgeRetrievalRequest(
                                ACTOR,
                                List.of(),
