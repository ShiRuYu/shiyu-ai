...
class EnterpriseDocumentServiceImplTenantTest {
    ...
    void registersNewStoredFileWithVersionAndIngestionJob() {
        ...
        doAnswer(invocation -> { com.shiyu.ai.knowledge.implementation.domain.model.KnowledgeIngestionJobBO value = invocation.getArgument(1); value.setId(22L); return null; }).when(enterprise).insertJob(eq(new TenantId(1L)), any());
