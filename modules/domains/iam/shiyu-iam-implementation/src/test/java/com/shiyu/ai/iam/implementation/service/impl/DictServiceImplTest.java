...
class DictServiceImplTest {
    ...
    void pagesCachesByTypeAndUsesTenantForCrud() {
        ...
        dict.setId(4L);
        dict.setTenantId(3L);
        dict.setDictType("level");
        dict.setDictLabel("High");
        dict.setDictValue("3");
        ...
        request.setDictLabel("Medium");
        request.setDictValue("2");
        ...
        service.deleteById(ACTOR, 4L);
        service.deleteByIds(ACTOR, List.of(4L));
    ...
    void coversNullResultsAndTenantMismatchBranches() {
        ...
        DictRequest request = new DictRequest();
        request.setDictType("level");
        DictBO created = new DictBO();
        created.setId(8L);
        created.setTenantId(3L);
        created.setDictType("level");
        ...
        DictBO foreign = new DictBO();
        foreign.setId(10L);
        foreign.setTenantId(99L);
        foreign.setDictType("x");
