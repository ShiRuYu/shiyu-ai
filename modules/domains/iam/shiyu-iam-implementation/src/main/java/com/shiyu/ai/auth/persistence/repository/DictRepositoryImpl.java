...
import com.shiyu.ai.auth.persistence.dataobject.DictDO;
import com.shiyu.ai.auth.persistence.mapper.DictMapper;
 ...
 */
@Component
public class DictRepositoryImpl implements com.shiyu.ai.auth.port.repository.DictRepository {
    ...
    public Pair<Long, List<DictBO>> selectPage(TenantId tenantId, Number pageNo, Number pageSize) {
        ...
        addTenantFilter(countWrapper, tenantId);
    ...
    private void addTenantFilter(QueryWrapper queryWrapper, TenantId tenantId) {
