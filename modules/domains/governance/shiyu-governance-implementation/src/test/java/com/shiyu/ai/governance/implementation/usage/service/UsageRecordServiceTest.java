...
class UsageRecordServiceTest {
    ...
    void rejectsEmbeddingUsageWithoutAnExplicitActor() {
        assertThrows(
                NullPointerException.class,
                () -> service.recordEmbedding("embedding", 10, 3, 1, 2, null, 7L, "document-1"));
        assertThrows(
                NullPointerException.class,
                () ->
    ...
    void recordsContractUsageWithExplicitOwnershipAndSourceIdentity() {
        ...
        DomainEventEnvelope<UsageMeasurement> envelope =
    ...
    void rejectsActorMismatchAndTenantMismatch() {
        ...
        UsageMeasurement measurement =
                new UsageMeasurement(
                        ...
                        1,
                        Map.of());
        DomainEventEnvelope<UsageMeasurement> wrongUser =
                new DomainEventEnvelope<>(
                        actor.tenantId(),
                        new UserId(8),
        ...
        DomainEventEnvelope<UsageMeasurement> wrongTenant =
                new DomainEventEnvelope<>(
                        new TenantId(8),
                        actor.userId(),
                        new CorrelationId("corr"),
    ...
    void recordsEmbeddingContractUsageAndPublishesOnlyAfterInsert() {
        ...
        DomainEventEnvelope<UsageMeasurement> envelope =
                new DomainEventEnvelope<>(
                        actor.tenantId(),
                        actor.userId(),
                        new CorrelationId("corr-embedding"),
                        Instant.parse("2026-08-24T04:00:00Z"),
                        measurement);
    ...
    void usesExternalPricingAndGenerationRunAsTheStableSourceIdentity() {
        ...
        when(pricing.price("OPENAI", "gpt"))
                .thenReturn(
                        new BillingPriceProvider.PriceSnapshot(
                                "OPENAI",
                                "gpt",
        ...
        service.recordUsage(
                "OPENAI", "gpt", 3, 4, 5, new TenantId(9L), 7L, "session", "generation-1");
    ...
    void handlesMalformedOptionalRealtimeValuesWithoutOverflow() {
        ...
        service.setRealtimePublisher(publisher);
        service.recordEmbedding(
                "embed", 10, 3, Integer.MAX_VALUE, 2, new TenantId(9L), 7L, "session");
    ...
    void usesStableFallbacksForBlankGenerationIdsAndMalformedEmbeddingAttributes() {
        service.registerPricing(
                new com.shiyu.ai.governance.implementation.usage.model.ModelPricing(
                        "LOCAL", "model", 0.1, 0.2));
