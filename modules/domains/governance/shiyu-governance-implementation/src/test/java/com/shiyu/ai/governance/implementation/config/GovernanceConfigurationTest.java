package com.shiyu.ai.governance.implementation.config;
...
class GovernanceConfigurationTest {
    ...
    void wiresUsageRecordServiceWithOptionalAdapters() {
        ...
        UsageRecordService service =
                configuration.usageRecordService(repository, publisher, pricing);
    ...
    void exposesWebSocketBeansAndRegistersTheUsageEndpoint() {
        ...
        doReturn(registration)
                .when(registry)
                .addHandler(any(UsageWebSocketHandler.class), any(String[].class));
