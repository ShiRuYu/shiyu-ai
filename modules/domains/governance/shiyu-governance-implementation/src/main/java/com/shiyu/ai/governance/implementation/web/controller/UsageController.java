...
/**
 * 处理 用量 相关的 Web 请求，并将请求转换为应用服务调用。
 */
@Slf4j
...
public class UsageController {
    ...
    /**
     * 执行 用量 相关业务操作，并维护必要的状态和协作关系。
     *
     * @param usageService 用于完成本次业务处理的 usageService 参数。
     */
     ...
     * 执行 用量 相关业务操作，并维护必要的状态和协作关系。
     *
     * @param Embedding 用于完成本次业务处理的 Embedding 参数。
     */
