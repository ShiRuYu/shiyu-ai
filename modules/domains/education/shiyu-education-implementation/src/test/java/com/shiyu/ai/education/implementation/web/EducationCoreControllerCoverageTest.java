...
/**
 * Exercises the concrete education HTTP facades with typed actor context. This deliberately calls
 * named endpoints rather than discovering methods reflectively, so a changed endpoint signature
...
class EducationCoreControllerCoverageTest {
    ...
    void delegatesCourseExamAnalyticsAndChapterEndpoints() {
        ...
        when(analyticsService.listRecordsByStudentAndKnowledge(actorContext, 11L, 22L))
                .thenReturn(List.of());
