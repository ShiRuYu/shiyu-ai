...
import com.shiyu.ai.education.implementation.web.dto.AbilityResponse;
...
public interface AnalyticsService {
    ...
    /** 获取能力雷达图数据 */
    com.shiyu.ai.education.implementation.web.dto.AbilityRadarResponse getAbilityRadar(ActorContext actor, Long studentId, Long knowledgeId);

    /** 获取学习概览 */
    com.shiyu.ai.education.implementation.web.dto.OverviewResponse getOverview(ActorContext actor, Long studentId);

    /** 获取薄弱知识点列表（掌握度 < 60） */
    java.util.List<com.shiyu.ai.education.implementation.web.dto.WeakPointResponse> getWeakPoints(ActorContext actor, Long studentId);

    /** 获取学习趋势（近7天学习量） */
    com.shiyu.ai.education.implementation.web.dto.TrendResponse getTrend(ActorContext actor, Long studentId);
}
