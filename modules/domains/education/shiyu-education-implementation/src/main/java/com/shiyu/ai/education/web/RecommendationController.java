...
public class RecommendationController {
    ...
    public Result<List<KnowledgeRecommendResponse>> recommendKnowledge(
        ...
        return Result.success(recommendationService.recommendKnowledge(ActorContextHttpAdapter.currentActor(), studentId, topK));
    }
    ...
    public Result<List<QuestionRecommendResponse>> recommendQuestions(
        ...
        return Result.success(recommendationService.recommendQuestions(ActorContextHttpAdapter.currentActor(), studentId, count));
    }
    ...
    public Result<List<ResourceRecommendResponse>> recommendResources(
        ...
        return Result.success(recommendationService.recommendResources(ActorContextHttpAdapter.currentActor(), studentId, topK));
    }
    ...
    public Result<List<QuestionRecommendResponse>> recommendReview(
        ...
        return Result.success(recommendationService.recommendReviewTasks(ActorContextHttpAdapter.currentActor(), studentId, count));
    }
