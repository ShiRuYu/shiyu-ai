...
import com.shiyu.ai.agent.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean updateUser(Long userId, UserBO userBO) {
        ...
        UserBO existingUser = userRepository.selectOneById(userId);
    ...
    public boolean resetUserPassword(Long userId, String password) {
        ...
        UserBO userBO = userRepository.selectOneById(userId);
        if (userBO == null) {
            return false;
        }
