...
import com.shiyu.ai.agent.controller.request.LoginRequest;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> switchCurrentRole(
        ...
        try {
            ...
            // 调用切换角色服务
            LoginResponse response = authService.switchCurrentRole(username, roleCode);
