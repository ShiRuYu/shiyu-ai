...
@RestController
@RequestMapping("/siliconFlow")
@Slf4j
public class SiliconFlowChatModelController {

    private final ChatModel chatModel;

    private final ChatClient chatClient;

    public SiliconFlowChatModelController(@Qualifier("siliconFlowChatModel") ChatModel chatModel, SyncMcpToolCallbackProvider provider) {
