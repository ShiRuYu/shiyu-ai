...
| `modules/applications/shiyu-ai-bootstrap` | 技术支持 | Spring Boot 入口、配置、H2/v4 初始化、健康检查 | 所有启用的 implementation |
...
本地运行数据位于 `shiyu-ai/runtime/dev/data`，包含 H2 数据库、文件、日志和向量索引；备份目录不参与源码装配。
