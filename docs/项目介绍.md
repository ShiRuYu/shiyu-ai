...
ShiYu AI 是一个可扩展的企业级 Agent/RAG 后端平台。它以 Conversation、Runtime 和可视化 Agent 图编排为核心，把模型接入、知识检索、MAGMA-based 记忆、工具调用、权限、用量和插件等通用能力组合成平台底座，并在此之上提供智能教育与日常记录两个业务域。
