...
> 未完成的 P2 任务：P2-3 单元测试（20h，待后续补充）；P2-8 Plugin 系统已提前完成 ✅
...
```
Week 1-2: P0-1 (Core 拆分) + P0-7 (BO 收归)                ✅ 已完成
Week 3-4: P0-2 (Agent Runtime) + P0-6 (事件中心)            ✅ 已完成
Week 5-6: P0-3 (Memory) + P0-4 (VectorStore)               ✅ 已完成
Week 7-8: P0-5 (Usage) + P1-2 (Observability)              ✅ 已完成
Week 9-10: P1-1 (NodeFactory) + P1-3 (Flyway)              ✅ 已完成
Week 11-12: P1-4~P1-6 + P2 任务                             ✅ 已完成
```
