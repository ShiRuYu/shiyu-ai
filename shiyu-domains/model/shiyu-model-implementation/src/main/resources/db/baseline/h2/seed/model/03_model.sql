...
INSERT INTO "PUBLIC"."MODEL_AI_PLATFORM" VALUES(1, 'OpenAI', 'OPENAI', 1, 'https://api.openai.com/v1', '', 0.7, 4096, 3, '["gpt-4o","gpt-4o-mini","gpt-4-turbo","gpt-3.5-turbo"]', NULL, 'N', 1, 'OpenAI 官方 API', NULL, 'system', CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP, 0);
INSERT INTO "PUBLIC"."MODEL_AI_PLATFORM" VALUES(2, 'DeepSeek', 'DEEPSEEK', 1, 'https://api.deepseek.com', '', 0.7, 4096, 3, '["deepseek-v4-flash","deepseek-reasoner"]', NULL, 'Y', 1, 'DeepSeek 官方 API', NULL, 'system', CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP, 0);
INSERT INTO "PUBLIC"."MODEL_AI_PLATFORM" VALUES(3, 'OpenRouter', 'OPENROUTER', 1, 'https://openrouter.ai/api', '', 0.7, 4096, 3, '["x-ai/grok-4.1-fast","anthropic/claude-3.5-sonnet","google/gemini-2.5-pro"]', NULL, 'N', 1, 'OpenRouter 聚合 API', NULL, 'system', CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP, 0);
INSERT INTO "PUBLIC"."MODEL_AI_PLATFORM" VALUES(4, '硅基流动（通义千问）', 'SILICON_FLOW', 1, 'https://api.siliconflow.cn', '', 0.7, 4096, 3, '["Qwen/Qwen3-14B","Qwen/Qwen3-8B"]', NULL, 'N', 1, '硅基流动（通义千问）平台 - 通义千问 Qwen 模型服务', NULL, 'system', CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP, 0);
