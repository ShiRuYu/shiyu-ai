...
@Component
public class TenantRepositoryImpl implements com.shiyu.ai.auth.port.repository.TenantRepository {
    ...
    public TenantBO insert(TenantBO tenantBO, TenantId sourceTenantId) {
        requireTenant(sourceTenantId);
