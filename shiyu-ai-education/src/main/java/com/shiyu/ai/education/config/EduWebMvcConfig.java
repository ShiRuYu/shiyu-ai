package com.shiyu.ai.education.config;
 ...
 * 教育模块路由前缀配置
 *
 * 给 com.shiyu.ai.education.controller 包下所有 Controller 统一添加 /edu 前缀，
...
public class EduWebMvcConfig implements WebMvcConfigurer {
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
        configurer.addPathPrefix("/edu", clazz ->
            clazz.getPackageName().startsWith("com.shiyu.ai.education.controller")
        );
    }
}
