...
-- 教育域完整种子数据
-- 使用 agent 数据源，自动加载
-- 涵盖 auth 已有用户：vben(0) / admin(1) / jack(2)
-- ============================================================
...
-- ============================================================
-- 5. 教师（关联 auth 用户：vben(0)=张老师, admin(1)=李老师）
-- ============================================================
...
-- ============================================================
-- 6. 学生（关联 auth 用户：admin(1)=小明, jack(2)=小红, vben(0)=小华）
-- ============================================================
...
(14, 3, 2, 65, 55, 45, 35, 25, 20, 45.5);   -- 整数

-- ============================================================
-- 14. 学习记录（反映不同学生的周学习模式）
-- ============================================================
...
-- 小红错题（极少）
(6, 2, 11, 5, '2', 1);     -- 竞赛题漏考虑一个变量（连续正确1次）
