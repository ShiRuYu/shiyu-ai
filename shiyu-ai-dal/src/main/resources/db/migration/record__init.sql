...
-- 插入人物数据
INSERT INTO profile (id, name, tenant_id, workspace_id, gender, birth_date, avatar, status, del_flag, create_by, update_by) VALUES
...
-- 插入人物成员关系
INSERT INTO profile_member (profile_id, user_id, tenant_id, workspace_id, role, create_by, update_by) VALUES
...
-- 插入时间轴事件
INSERT INTO timeline_event (id, profile_id, title, tenant_id, workspace_id, event_time, type, visibility, created_by, create_by, update_by) VALUES
...
-- 插入记录内容
INSERT INTO record (id, event_id, tenant_id, workspace_id, content, mood, location, weather, create_by, update_by) VALUES
...
-- 插入记录标签关联
INSERT INTO record_tag (record_id, tag_id, tenant_id, workspace_id) VALUES
