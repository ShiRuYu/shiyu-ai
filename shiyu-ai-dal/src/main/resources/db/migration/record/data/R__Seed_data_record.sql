...
-- 人物
INSERT IGNORE INTO profile (id, name, tenant_id, gender, birth_date, avatar, status, del_flag, create_by, update_by) VALUES
...
-- 人物成员关系
INSERT IGNORE INTO profile_member (profile_id, user_id, tenant_id, role, create_by, update_by) VALUES
...
-- 时间轴事件
INSERT IGNORE INTO timeline_event (id, profile_id, title, tenant_id, event_time, type, visibility, create_by, update_by) VALUES
...
-- 记录内容
INSERT IGNORE INTO record (id, event_id, tenant_id, content, mood, location, weather, create_by, update_by) VALUES
...
-- 媒体
INSERT IGNORE INTO media (id, record_id, url, tenant_id, type, size, sort, bucket, object_key, create_by, update_by) VALUES
...
-- 标签
INSERT IGNORE INTO tag (id, name, tenant_id, create_by, update_by) VALUES
...
-- 记录-标签关联
INSERT IGNORE INTO record_tag (record_id, tag_id, tenant_id) VALUES
(1, 1, 1), (1, 2, 1),
(2, 3, 1), (2, 2, 1),
(3, 4, 1),
(4, 1, 1), (4, 6, 1),
