...
INSERT IGNORE INTO `ai_platform` (`id`, `name`, `code`, `tenant_id`, `workspace_id`, `base_url`, `api_key`, `temperature`, `max_tokens`, `max_retries`, `available_models`, `extra_config`, `is_default`, `status`, `remark`)
...
INSERT IGNORE INTO `ai_model` (`platform_id`, `model_name`, `tenant_id`, `workspace_id`, `display_name`, `description`, `is_default`, `status`, `sort`)
...
INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `workspace_id`, `current_version`, `status`, `ext_info`)
...
INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `workspace_id`, `description`, `status`, `graph_config`, `canvas_config`, `ext_info`)
...
INSERT IGNORE INTO `intent_def` (`agent_id`, `code`, `name`, `tenant_id`, `workspace_id`, `description`, `category`, `priority`, `confidence_threshold`, `examples`, `require_slot_filling`, `target_node`)
...
INSERT IGNORE INTO `intent_def` (`agent_id`, `code`, `name`, `tenant_id`, `workspace_id`, `description`, `category`, `priority`, `confidence_threshold`, `examples`, `slots`, `require_slot_filling`, `target_node`)
...
INSERT IGNORE INTO `intent_def` (`agent_id`, `code`, `name`, `tenant_id`, `workspace_id`, `description`, `category`, `priority`, `confidence_threshold`, `examples`, `require_slot_filling`, `slots`, `target_node`)
...
INSERT IGNORE INTO `intent_def` (`agent_id`, `code`, `name`, `tenant_id`, `workspace_id`, `description`, `category`, `priority`, `confidence_threshold`, `examples`, `require_slot_filling`, `slots`, `parameter_mapping`, `slot_defaults`, `target_node`)
