...
VALUES (900, '学习中心', 'Learning', 'CATALOG', NULL, 1, '/learning', '/learning/course', 'lucide:book-open', '', '', TRUE, NULL, '学生学习入口', TRUE, '1', 10, 0, '0', '0');

INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (901, '课程学习', 'LearningCourse', 'MENU', 900, 1, '/learning/course', NULL, 'lucide:book', '/learning/course/list', '', TRUE, NULL, '课程列表与学习', TRUE, '1', 1, 0, '0', '0');
...
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (902, '知识浏览', 'LearningKnowledge', 'MENU', 900, 1, '/learning/knowledge', NULL, 'lucide:brain', '/learning/knowledge/list', '', TRUE, NULL, '知识点浏览与搜索', TRUE, '1', 2, 0, '0', '0');

INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (90201, '知识查询', 'learning:knowledge:query', 'BUTTON', 902, 1, NULL, NULL, NULL, NULL, NULL, NULL, 'GET', '查询知识点', TRUE, '1', 1, 0, '0', '0');

INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (903, '学习计划', 'LearningPlan', 'MENU', 900, 1, '/learning/plan', NULL, 'lucide:calendar-check', '/learning/plan/list', '', TRUE, NULL, '学习计划与每日任务', TRUE, '1', 3, 0, '0', '0');
...
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (904, '学习资源', 'LearningResource', 'MENU', 900, 1, '/learning/resource', NULL, 'lucide:folder-open', '/learning/resource/list', '', TRUE, NULL, '学习资源浏览', TRUE, '1', 4, 0, '0', '0');
...
-- ============================================
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1000, '练习中心', 'Practice', 'CATALOG', NULL, 1, '/practice', '/practice/question', 'lucide:pen-tool', '', '', TRUE, NULL, '题库练习与错题本', TRUE, '1', 20, 0, '0', '0');

INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1001, '题库练习', 'PracticeQuestion', 'MENU', 1000, 1, '/practice/question', NULL, 'lucide:list-checks', '/practice/question/list', '', TRUE, NULL, '按学科/年级/难度练习', TRUE, '1', 1, 0, '0', '0');
...
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1002, '错题本', 'PracticeWrong', 'MENU', 1000, 1, '/practice/wrong', NULL, 'lucide:x-circle', '/practice/wrong-question/list', '', TRUE, NULL, '学生错题管理', TRUE, '1', 2, 0, '0', '0');
...
-- ============================================
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1100, '考试中心', 'Exam', 'CATALOG', NULL, 1, '/exam', '/exam/list', 'lucide:clipboard-check', '', '', TRUE, NULL, '在线考试与AI组卷', TRUE, '1', 30, 0, '0', '0');

INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1101, '在线考试', 'ExamList', 'MENU', 1100, 1, '/exam/list', NULL, 'lucide:file-text', '/exam/exam-list/list', '', TRUE, NULL, '考试列表与答题', TRUE, '1', 1, 0, '0', '0');
...
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1102, 'AI组卷', 'ExamAiExam', 'MENU', 1100, 1, '/exam/ai-exam', NULL, 'lucide:sparkles', '/exam/ai-exam/index', '', TRUE, NULL, 'AI智能组卷', TRUE, '1', 2, 0, '0', '0');
...
-- ============================================
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1200, '复习中心', 'Review', 'CATALOG', NULL, 1, '/review', '/review/today', 'lucide:repeat', '', '', TRUE, NULL, '艾宾浩斯复习管理', TRUE, '1', 40, 0, '0', '0');

INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1201, '今日复习', 'ReviewToday', 'MENU', 1200, 1, '/review/today', NULL, 'lucide:calendar-days', '/review/today/list', '', TRUE, NULL, '今日艾宾浩斯复习任务', TRUE, '1', 1, 0, '0', '0');
...
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1202, '复习历史', 'ReviewHistory', 'MENU', 1200, 1, '/review/history', NULL, 'lucide:history', '/review/history/list', '', TRUE, NULL, '复习历史记录', TRUE, '1', 2, 0, '0', '0');
...
-- ============================================
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1300, '数据中心', 'AnalyticsCenter', 'CATALOG', NULL, 1, '/analytics-center', '/analytics-center/report', 'lucide:bar-chart-3', '', '', TRUE, NULL, '学习数据分析', TRUE, '1', 50, 0, '0', '0');
...
-- ============================================
INSERT INTO `menu` (`id`, `name`, `code`, `type`, `parent_id`, `tenant_id`, `path`, `redirect`, `icon`, `component`, `layout`, `keep_alive`, `method`, `description`, `show`, `status`, `order`, `del_flag`, `create_by`, `update_by`)
VALUES (1400, 'AI助手', 'AiTutor', 'CATALOG', NULL, 1, '/ai-tutor', '/ai-tutor/teacher', 'lucide:bot', '', '', TRUE, NULL, 'AI教学助手', TRUE, '1', 60, 0, '0', '0');
...
-- ============================================
-- 8. 更新教育管理(700)菜单组件路径，匹配前端 views 目录
-- ============================================
UPDATE `menu` SET `component` = '/education-admin/subject/list' WHERE `id` = 701;
UPDATE `menu` SET `component` = '/education-admin/textbook/list' WHERE `id` = 702;
UPDATE `menu` SET `component` = '/education-admin/chapter/list' WHERE `id` = 703;
UPDATE `menu` SET `component` = '/education-admin/course-admin/list' WHERE `id` = 704;
UPDATE `menu` SET `component` = '/education-admin/exam-admin/list' WHERE `id` = 705;
UPDATE `menu` SET `component` = '/education-admin/question-admin/list' WHERE `id` = 706;
UPDATE `menu` SET `component` = '/education-admin/plan/list' WHERE `id` = 707;
UPDATE `menu` SET `component` = '/education-admin/review/list' WHERE `id` = 708;
UPDATE `menu` SET `component` = '/education-admin/analytics/index' WHERE `id` = 709;
UPDATE `menu` SET `component` = '/education-admin/resource-admin/list' WHERE `id` = 710;
UPDATE `menu` SET `component` = '/education-admin/wrong-question/list' WHERE `id` = 711;

-- 更新教育管理路径
UPDATE `menu` SET `path` = '/edu/subject' WHERE `id` = 701;
UPDATE `menu` SET `path` = '/edu/textbook' WHERE `id` = 702;
UPDATE `menu` SET `path` = '/edu/chapter' WHERE `id` = 703;
UPDATE `menu` SET `path` = '/edu/course' WHERE `id` = 704;
UPDATE `menu` SET `path` = '/edu/exam' WHERE `id` = 705;
UPDATE `menu` SET `path` = '/edu/question' WHERE `id` = 706;
UPDATE `menu` SET `path` = '/edu/plan' WHERE `id` = 707;
UPDATE `menu` SET `path` = '/edu/review' WHERE `id` = 708;
UPDATE `menu` SET `path` = '/edu/analytics' WHERE `id` = 709;
UPDATE `menu` SET `path` = '/edu/resource' WHERE `id` = 710;
UPDATE `menu` SET `path` = '/edu/wrong-question' WHERE `id` = 711;

-- 更新教育管理父菜单
UPDATE `menu` SET `path` = '/edu', `redirect` = '/edu/subject' WHERE `id` = 700;

-- 更新知识引擎组件路径
UPDATE `menu` SET `component` = '/knowledge-engine/knowledge-list/list' WHERE `id` = 601;
UPDATE `menu` SET `component` = '/knowledge-engine/knowledge-graph/index' WHERE `id` = 603;
UPDATE `menu` SET `component` = '/knowledge-engine/document/list' WHERE `id` = 604;
UPDATE `menu` SET `component` = '/knowledge-engine/index-rebuild/list' WHERE `id` = 605;

-- 更新知识引擎路径
UPDATE `menu` SET `path` = '/knowledge/list' WHERE `id` = 601;
UPDATE `menu` SET `path` = '/knowledge/graph' WHERE `id` = 603;
UPDATE `menu` SET `path` = '/knowledge/document' WHERE `id` = 604;
UPDATE `menu` SET `path` = '/knowledge/index' WHERE `id` = 605;
