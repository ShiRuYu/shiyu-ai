...
-- AI 平台
INSERT IGNORE INTO `ai_platform` (`id`, `name`, `code`, `tenant_id`, `scoped_tenant_id`, `base_url`, `api_key`, `temperature`, `max_tokens`, `max_retries`, `available_models`, `is_default`, `status`, `remark`, `create_by`, `update_by`)
VALUES (1, 'OpenAI', 'OPENAI', 1, 1, 'https://api.openai.com/v1', '', 0.7, 4096, 3,
        '["gpt-4o","gpt-4o-mini","gpt-4-turbo","gpt-3.5-turbo"]', 'N', 1, 'OpenAI 官方 API', 'system', 'system');

INSERT IGNORE INTO `ai_platform` (`id`, `name`, `code`, `tenant_id`, `scoped_tenant_id`, `base_url`, `api_key`, `temperature`, `max_tokens`, `max_retries`, `available_models`, `is_default`, `status`, `remark`, `create_by`, `update_by`)
VALUES (2, 'DeepSeek', 'DEEPSEEK', 1, 1, 'https://api.deepseek.com', '', 0.7, 4096, 3,
        '["deepseek-chat","deepseek-reasoner"]', 'Y', 1, 'DeepSeek 官方 API', 'system', 'system');

INSERT IGNORE INTO `ai_platform` (`id`, `name`, `code`, `tenant_id`, `scoped_tenant_id`, `base_url`, `api_key`, `temperature`, `max_tokens`, `max_retries`, `available_models`, `is_default`, `status`, `remark`, `create_by`, `update_by`)
VALUES (3, 'OpenRouter', 'OPENROUTER', 1, 1, 'https://openrouter.ai/api', '', 0.7, 4096, 3,
        '["x-ai/grok-4.1-fast","anthropic/claude-3.5-sonnet","google/gemini-2.5-pro"]', 'N', 1, 'OpenRouter 聚合 API', 'system', 'system');

-- 硅基流动（通义千问 Qwen 模型系列）
INSERT IGNORE INTO `ai_platform` (`id`, `name`, `code`, `tenant_id`, `scoped_tenant_id`, `base_url`, `api_key`, `temperature`, `max_tokens`, `max_retries`, `available_models`, `is_default`, `status`, `remark`, `create_by`, `update_by`)
VALUES (4, '硅基流动（通义千问）', 'SILICON_FLOW', 1, 1, 'https://api.siliconflow.cn', '', 0.7, 4096, 3,
        '["Qwen/Qwen3-14B","Qwen/Qwen3-8B"]', 'N', 1, '硅基流动（通义千问）平台 - 通义千问 Qwen 模型服务', 'system', 'system');

-- AI 模型
INSERT IGNORE INTO `ai_model` (`id`, `platform_id`, `model_name`, `tenant_id`, `scoped_tenant_id`, `display_name`, `is_default`, `status`, `sort`, `create_by`, `update_by`)
VALUES (1, 1, 'gpt-4o', 1, 1, 'GPT-4o', 'N', 1, 1, 'system', 'system'),
       (2, 1, 'gpt-4o-mini', 1, 1, 'GPT-4o Mini', 'Y', 1, 2, 'system', 'system'),
       (3, 1, 'gpt-3.5-turbo', 1, 1, 'GPT-3.5 Turbo', 'N', 1, 3, 'system', 'system'),
       (4, 2, 'deepseek-chat', 1, 1, 'DeepSeek Chat', 'Y', 1, 1, 'system', 'system'),
       (5, 2, 'deepseek-reasoner', 1, 1, 'DeepSeek Reasoner', 'N', 1, 2, 'system', 'system'),
       (6, 3, 'x-ai/grok-4.1-fast', 1, 1, 'Grok 4.1 Fast', 'N', 1, 1, 'system', 'system'),
       (7, 3, 'anthropic/claude-3.5-sonnet', 1, 1, 'Claude 3.5 Sonnet', 'Y', 1, 2, 'system', 'system'),
       -- 硅基流动（通义千问）平台模型
       (8, 4, 'Qwen/Qwen3-14B', 1, 1, 'Qwen3 14B', 'N', 1, 1, 'system', 'system'),
       (9, 4, 'Qwen/Qwen3-8B', 1, 1, 'Qwen3 8B', 'Y', 1, 2, 'system', 'system');

-- Agent 定义
INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (1, 'tutor-bot', '辅导助手', '通用学科辅导 Agent（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (2, 'knowledge-tutor', '知识问答助手', '知识问答 Agent（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (3, 'gcx-assistant', 'GCX 助手', 'GCX 智能助手（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (4, 'simple-assistant', '简单助手', '基础 LLM 问答助手（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (5, 'rag-knowledge-agent', '知识库问答', '基于文档知识库的 RAG 检索问答（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (6, 'smart-agent', '智能路由助手', '意图识别 + RAG + 工具调用全功能智能助手（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

-- Agent 版本
INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (1, 'tutor-bot', 'v1.0.0', 1, 1, '初始版本', '1', 
...
INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (2, 'knowledge-tutor', 'v1.0.0', 1, 1, '初始版本', '1', 
...
INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (3, 'gcx-assistant', 'v1.0.0', 1, 1, '初始版本', '1', 
...
INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (4, 'simple-assistant', 'v1.0.0', 1, 1, '初始版本', '1', 
...
INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (5, 'rag-knowledge-agent', 'v1.0.0', 1, 1, '初始版本', '1', 
...
INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (6, 'smart-agent', 'v1.0.0', 1, 1, '初始版本', '1', 
...
-- 意图定义
INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (1, 'default', 'CHITCHAT', '闲聊', 1, 1, '日常闲聊对话', 'CONVERSATION', 10, 0.75, '1', 1, 'system', 'system');

INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (2, 'default', 'QUESTION', '问答', 1, 1, '知识问答', 'KNOWLEDGE', 50, 0.80, '1', 1, 'system', 'system');

INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (3, 'default', 'TRANSLATION', '翻译', 1, 1, '语言翻译', 'TASK', 60, 0.85, '1', 1, 'system', 'system');

INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (4, 'default', 'EDUCATION', '教育', 1, 1, '学科教育辅导', 'TASK', 70, 0.80, '1', 1, 'system', 'system');

INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (5, 'default', 'CODE_HELP', '代码帮助', 1, 1, '编程辅助与代码生成', 'TASK', 65, 0.80, '1', 1, 'system', 'system');

INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (6, 'default', 'WRITING_ASSISTANCE', '写作辅助', 1, 1, '文章写作与润色', 'TASK', 55, 0.75, '1', 1, 'system', 'system');

INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (7, 'default', 'DATA_ANALYSIS', '数据分析', 1, 1, '数据处理与分析', 'TASK', 60, 0.80, '1', 1, 'system', 'system');

INSERT IGNORE INTO `intent_def` (`id`, `agent_id`, `code`, `name`, `tenant_id`, `scoped_tenant_id`, `description`, `category`, `priority`, `confidence_threshold`, `enabled`, `status`, `create_by`, `update_by`)
VALUES (8, 'default', 'UNKNOWN', '未知意图', 1, 1, '无法识别的意图', 'CONVERSATION', 0, 0.50, '1', 1, 'system', 'system');
...
-- ============================================
INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (7, 'practice', 'AI出题助手', '根据知识点和难度智能生成练习题（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (7, 'practice', 'v1.0.0', 1, 1, '初始版本', '1', 
...
-- ============================================
INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (11, 'exam', 'AI组卷助手', '根据知识点和考试要求智能组卷（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (11, 'exam', 'v1.0.0', 1, 1, '初始版本', '1', 
'{"name":"exam-graph","description":"AI组卷工作流程","startNode":"input","endNode":"output","nodes":{"input":{"nodeName":"输入节点","nodeType":"DEFAULT","enabled":true},"llm":{"nodeName":"AI组卷","nodeType":"LLM_CALL","enabled":true,"config":{"platform":"SILICON_FLOW","modelName":"Qwen/Qwen3-8B","defaultPrompt":"请根据知识点和考试要求生成一份完整的试卷。","promptTemplate":"请根据以下参数生成一份完整的试卷。\n\n## 组卷参数\n- 知识点ID: {knowledgeId}\n- 学生ID: {studentId}\n- 难度级别: {difficulty}\n- 题目数量: {count}\n- 考试时长: {duration} 分钟\n\n请生成 {count} 道题目，包含选择题、填空题和解答题。"}},"output":{"nodeName":"输出格式化","nodeType":"OUTPUT_FORMAT","enabled":true,"config":{"outputFormat":"TEXT","prettyPrint":true}}},"edges":{"input":["llm"],"llm":["output"]},"conditionalEdges":{}}',
'{"zoom":1,"offsetX":0,"offsetY":0,"nodePositions":{"input":{"x":100,"y":100},"llm":{"x":300,"y":100},"output":{"x":500,"y":100}}}',
'system', 'system');
...
-- ============================================
INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (8, 'teacher', 'AI讲解助手', '根据知识点进行智能教学讲解（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (8, 'teacher', 'v1.0.0', 1, 1, '初始版本', '1', 
...
-- ============================================
INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (9, 'planner', '学习规划助手', '根据知识点生成个性化学习规划（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (9, 'planner', 'v1.0.0', 1, 1, '初始版本', '1', 
...
-- ============================================
INSERT IGNORE INTO `agent_def` (`id`, `agent_id`, `name`, `description`, `tenant_id`, `scoped_tenant_id`, `current_version`, `status`, `create_by`, `update_by`)
VALUES (10, 'report', '学习报告助手', '基于学习数据生成学习分析报告（使用硅基流动 Qwen3-8B 模型）', 1, 1, 'v1.0.0', 1, 'system', 'system');

INSERT IGNORE INTO `agent_version` (`id`, `agent_id`, `version_number`, `tenant_id`, `scoped_tenant_id`, `description`, `status`, `graph_config`, `canvas_config`, `create_by`, `update_by`)
VALUES (10, 'report', 'v1.0.0', 1, 1, '初始版本', '1', 
