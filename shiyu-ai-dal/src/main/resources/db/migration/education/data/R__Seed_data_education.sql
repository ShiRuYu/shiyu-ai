...
-- 学科
INSERT IGNORE INTO `subject` (`id`, `code`, `name`, `grade_level`, `icon`, `sort_order`, `status`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 教材
INSERT IGNORE INTO `textbook` (tenant_id, `id`, `name`, `subject_code`, `grade`, `publisher`, `isbn`, `create_by`, `update_by`) VALUES
...
-- 章节（教材1：人教版数学七年级上册）
INSERT IGNORE INTO `chapter` (tenant_id, `id`, `textbook_id`, `parent_id`, `name`, `chapter_order`, `create_by`, `update_by`) VALUES
...
-- 知识点-教材关联
INSERT IGNORE INTO `knowledge_textbook` (`knowledge_id`, `textbook_id`, `chapter_id`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 学生
INSERT IGNORE INTO `student` (`id`, `user_id`, `student_no`, `name`, `gender`, `grade`, `grade_level`, `school`, `class_name`, `tenant_id`, `create_by`, `update_by`) VALUES
(1, 4, 'STU2024001', '王小明', 1, 7, 'K3', '阳光中学', '七年级一班', 1, 'system', 'system');

-- 教师
INSERT IGNORE INTO `teacher` (`id`, `user_id`, `teacher_no`, `name`, `subject`, `school`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 课程
INSERT IGNORE INTO `course` (`id`, `name`, `description`, `subject_code`, `grade`, `textbook_id`, `teacher_id`, `status`, `tenant_id`, `create_by`, `update_by`) VALUES
(1, '七年级数学上册', '人教版七年级数学上册基础课程', 'MATH', 7, 1, 1, 1, 1, 'system', 'system');

-- 课程章节
INSERT IGNORE INTO `course_chapter` (`id`, `course_id`, `name`, `order_no`, `tenant_id`, `create_by`, `update_by`) VALUES
(1, 1, '有理数', 1, 1, 'system', 'system'),
(2, 1, '整式的加减', 2, 1, 'system', 'system');

-- 课程小节
INSERT IGNORE INTO `course_section` (`id`, `chapter_id`, `name`, `order_no`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 课程-知识点关联
INSERT IGNORE INTO `course_knowledge` (`course_id`, `knowledge_id`, `section_id`, `sort_order`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 能力值
INSERT IGNORE INTO `ability` (`student_id`, `knowledge_id`, `remember`, `understand`, `apply`, `overall_mastery`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 学习资源
INSERT IGNORE INTO `resource` (`id`, `name`, `type`, `url`, `subject_code`, `grade`, `difficulty`, `cover_url`, `description`, `view_count`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 考试
INSERT IGNORE INTO `exam` (`id`, `name`, `type`, `subject_code`, `grade`, `duration_min`, `total_score`, `status`, `teacher_id`, `tenant_id`, `create_by`, `update_by`) VALUES
(1, '七年级数学第一章测验', 'UNIT_TEST', 'MATH', 7, 45, 100, 1, 1, 1, 'system', 'system'),
(2, '七年级数学期中考试', 'MIDTERM', 'MATH', 7, 90, 150, 1, 1, 1, 'system', 'system');

-- 考试分区
INSERT IGNORE INTO `exam_section` (`id`, `exam_id`, `name`, `order_no`, `score_per_q`, `tenant_id`, `create_by`, `update_by`) VALUES
(1, 1, '选择题', 1, 0, 1, 'system', 'system'),
(2, 1, '解答题', 2, 0, 1, 'system', 'system');

-- 考试-题目关联
INSERT IGNORE INTO `exam_question` (`exam_id`, `section_id`, `question_id`, `order_no`, `score`, `tenant_id`, `create_by`, `update_by`) VALUES
...
-- 错题记录
INSERT IGNORE INTO `wrong_question` (`id`, `student_id`, `question_id`, `knowledge_id`, `student_answer`, `correct_times`, `tenant_id`, `create_by`, `update_by`) VALUES
